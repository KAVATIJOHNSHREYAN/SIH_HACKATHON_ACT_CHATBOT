        ...
        <section id="features" className="py-20 relative" style={{ backgroundColor: '#ffffff', borderTop: '1.5px solid #dcfce7' }}>
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <GlassCard>
                <div className="h-12 w-12 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-600 mb-5">
                  <Cpu className="h-6 w-6" />
                </div>
                <h3 className="text-xl font-semibold text-slate-800 mb-2">Multi-Model Framework</h3>
              ...
              <GlassCard>
                <div className="h-12 w-12 rounded-xl bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-600 mb-5">
                  <Database className="h-6 w-6" />
                </div>
                <h3 className="text-xl font-semibold text-slate-800 mb-2">Automated Pinecone RAG</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
              ...
              <GlassCard>
                <div className="h-12 w-12 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-600 mb-5">
                  <Layers className="h-6 w-6" />
                </div>
                <h3 className="text-xl font-semibold text-slate-800 mb-2">Comprehensive OCR</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid lg:grid-cols-12 gap-8 items-stretch">
                  ...
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-xl border transition-all flex items-center justify-between ${
                      activeDemo.id === demo.id
                        ? "bg-purple-600/10 border-purple-500 text-purple-700 shadow-md"
                        : "bg-white/80 border-slate-200 text-slate-600 hover:bg-white hover:text-purple-600"
                    }`}
                  >
              ...
              <div className="lg:col-span-8">
                <GlassCard className="h-full flex flex-col p-0 overflow-hidden border-slate-200 bg-white shadow-sm">
                  ...
                  <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-slate-100 flex-1 min-h-[300px]">
                    ...
                    <div className="p-6 bg-purple-50/20">
                      <div className="text-xs font-semibold text-emerald-600 mb-2 uppercase tracking-wide flex items-center gap-1.5">
        ...
        <section className="py-20 border-t border-slate-100 bg-white/60">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 text-sm">Flexible input to output mapping across any medium.</p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto">
              {["PDF", "DOCX", "CSV", "PPTX", "Markdown", "HTML", "TXT", "JSON", "Audio MP3", "Scanned JPG", "Email templates", "Flashcards", "MCQs", "Legal documents", "Academic papers"].map((fmt) => (
                <span key={fmt} className="px-4 py-2 rounded-xl bg-white border border-slate-200 text-xs text-slate-700 font-medium shadow-sm hover:border-emerald-500 hover:text-emerald-700 transition-colors">
                  {fmt}
                </span>
              ))}
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="h-14 w-14 rounded-2xl bg-purple-100/80 border border-purple-200 flex items-center justify-center text-purple-700 mx-auto mb-6">
                  <span className="text-lg font-bold">1</span>
                </div>
                <h3 className="text-lg font-semibold text-slate-800 mb-2">Upload Your Source</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
              ...
              <div className="text-center">
                <div className="h-14 w-14 rounded-2xl bg-cyan-100/80 border border-cyan-200 flex items-center justify-center text-cyan-700 mx-auto mb-6">
                  <span className="text-lg font-bold">2</span>
                </div>
                <h3 className="text-lg font-semibold text-slate-800 mb-2">Select Target Format</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
              ...
              <div className="text-center">
                <div className="h-14 w-14 rounded-2xl bg-emerald-100/80 border border-emerald-200 flex items-center justify-center text-emerald-700 mx-auto mb-6">
                  <span className="text-lg font-bold">3</span>
                </div>
                <h3 className="text-lg font-semibold text-slate-800 mb-2">Verify & Export</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-stretch">
              <GlassCard className="flex flex-col">
                ...
                <p className="text-slate-500 text-xs mb-6">Perfect for testing ACT features.</p>
                ...
                <ul className="text-sm text-slate-600 space-y-3 mb-8 flex-1">
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-purple-600" /> 50 transformation credits</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-purple-600" /> 10MB max file size</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-purple-600" /> Standard AI Model Access</li>
                </ul>
              ...
              <GlassCard className="flex flex-col border-purple-200 bg-purple-50/30 relative">
                ...
                <p className="text-slate-500 text-xs mb-6">For power users and professionals.</p>
                <div className="text-3xl font-bold text-slate-900 mb-6">
                  $29 <span className="text-sm font-normal text-slate-500">/ mo</span>
                </div>
                <ul className="text-sm text-slate-600 space-y-3 mb-8 flex-1">
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-purple-600" /> 1,500 transformation credits</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-purple-600" /> 100MB max file size</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-purple-600" /> Access to Gemini Pro & GPT-4o</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-purple-600" /> Pinecone Vector Storage RAG</li>
                </ul>
                <Link href="/auth/register" className="w-full">
              ...
              <GlassCard className="flex flex-col">
                ...
                <p className="text-slate-500 text-xs mb-6">For large teams and companies.</p>
                <div className="text-3xl font-bold text-slate-900 mb-6">
                  Custom
                </div>
                <ul className="text-sm text-slate-600 space-y-3 mb-8 flex-1">
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-purple-600" /> Unlimited volume</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-purple-600" /> Custom model fine-tuning</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-purple-600" /> Dedicated Pinecone indices</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-purple-600" /> SSO & Audit Logs</li>
                </ul>
                <Link href="/auth/register" className="w-full">
        ...
        <section id="faq" className="py-20 border-t border-slate-100 bg-white/40">
          <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 text-sm">Have any queries? We have compiled common questions here.</p>
            </div>
            ...
            <div className="space-y-4">
              {faqs.map((faq, idx) => (
                <GlassCard
                  key={idx}
                  className="p-5 cursor-pointer border-slate-200 hover:border-purple-500/20"
      ...
      <footer className="border-t border-slate-200 bg-white py-12">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-slate-900">ACT Platform</span>
          </div>
