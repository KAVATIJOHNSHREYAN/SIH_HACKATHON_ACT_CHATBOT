  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-bold text-white capitalize">batch Transformation</h1>
          <p className="text-slate-400 text-xs mt-0.5">Automated pipeline specifically for batch source parsing and output compiling.</p>
        </div>
      </div>
      ...
      <GlassCard className="space-y-6">
        ...
        <div className="space-y-4">
          <p className="text-xs text-slate-400 leading-relaxed">
            This module isolates specialized extraction scripts and LLM prompts tuned for batch operations. Choose a target template below to execute.
          </p>
          <div className="p-10 border border-dashed border-white/10 hover:border-purple-500/30 rounded-xl text-center bg-slate-950/40 cursor-pointer">
            <span className="text-xs text-slate-400 font-semibold">Drop batch files here or click to load</span>
          </div>
        </div>
