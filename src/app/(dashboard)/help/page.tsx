  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div>
        ...
        <p className="text-slate-600 text-xs mt-1">Learn how to configure pipelines, build RAG indices, and prompt ACT.</p>
      </div>

      <div className="space-y-6">
        {sections.map((section, idx) => (
          <GlassCard key={idx} className="border-slate-200 bg-white shadow-sm flex gap-5 items-start">
