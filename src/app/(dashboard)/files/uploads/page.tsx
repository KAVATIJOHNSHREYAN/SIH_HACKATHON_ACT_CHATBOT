...
export default function FilesuploadsPage() {
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-bold text-white capitalize">uploads Directory</h1>
          <p className="text-slate-400 text-xs mt-0.5">Specialized browser view filter for uploads items.</p>
        </div>
      </div>
      ...
      <GlassCard className="flex items-center gap-4 p-8">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-400 leading-relaxed">
            Welcome to the dedicated uploads file hub. You can upload, star, search, or delete items inside this namespace.
          </p>
        </div>
      </GlassCard>
    </div>
